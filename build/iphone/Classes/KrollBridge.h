...
@interface UiTinVlaanderenObject : KrollCoverageObject {
#else
@interface UiTinVlaanderenObject : KrollObject {
#endif
@private
...
extern NSString * UiTinVlaanderen$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	UiTinVlaanderenObject *_uitinvlaanderen;
	BOOL shutdown;
