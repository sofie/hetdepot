...
// in simulator we redefine to format for UiTinVlaanderen Developer console
...
{\
	NSString * exceptionName = [@"org.uitinvlaanderen." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.uitinvlaanderen";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIUiTinVlaanderenNativeItemNone = -1, 
	UIUiTinVlaanderenNativeItemSpinner = -2,
	UIUiTinVlaanderenNativeItemProgressBar = -3,
	
	UIUiTinVlaanderenNativeItemSlider = -4,
	UIUiTinVlaanderenNativeItemSwitch = -5,
	UIUiTinVlaanderenNativeItemMultiButton = -6,
	UIUiTinVlaanderenNativeItemSegmented = -7,
	
	UIUiTinVlaanderenNativeItemTextView = -8,
	UIUiTinVlaanderenNativeItemTextField = -9,
	UIUiTinVlaanderenNativeItemSearchBar = -10,
	
	UIUiTinVlaanderenNativeItemPicker = -11,
	UIUiTinVlaanderenNativeItemDatePicker = -12,
	
	UIUiTinVlaanderenNativeItemInfoLight = -13,
	UIUiTinVlaanderenNativeItemInfoDark = -14,
	
	UIUiTinVlaanderenNativeItemDisclosure = -15,
	
	UIUiTinVlaanderenNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all UiTinVlaanderen instances of
