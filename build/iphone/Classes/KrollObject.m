 ...
 * Copyright (c) 2009-2011 by UiTinVlaanderen, Inc. All Rights Reserved.
...
//@interface UiTinVlaanderenObject : NSObject
//@end

@interface UiTinVlaanderenObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UiTinVlaanderenObject class]])
		{
			for (NSString *key in [[(UiTinVlaanderenObject*)o modules] allKeys])
			{
